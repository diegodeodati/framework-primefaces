...
//@FacesValidator("it.betplus.moneyphone.validators.MacAddressValidator")

public class MacAddressValidator extends ValidatorCommon implements Validator {
	...
	public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
		...
		if (!Validators.checkMacAddress((String) value)) {
			currentContext.execute("validationResult('" + component.getClientId() + "', '" + false + "', '" + getFromBundleMsgs("invalid_mac_address_format") + "');");
			throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, "Fail", getFromBundleMsgs("invalid_mac_address_format")));
		}
	}
