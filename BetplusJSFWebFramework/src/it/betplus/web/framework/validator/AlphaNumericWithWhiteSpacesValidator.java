...
//@FacesValidator("it.betplus.moneyphone.validators.AlphaNumericWithWhiteSpacesValidator")

public class AlphaNumericWithWhiteSpacesValidator extends ValidatorCommon implements Validator {
	...
	public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
		...
		if (!Validators.checkAlphaNumericWhiteSpaces((String) value)) {
