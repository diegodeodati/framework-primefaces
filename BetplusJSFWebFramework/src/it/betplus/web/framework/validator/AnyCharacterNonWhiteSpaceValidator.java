...
//@FacesValidator("it.betplus.moneyphone.validators.AnyCharacterNonWhiteSpaceValidator")

public class AnyCharacterNonWhiteSpaceValidator extends ValidatorCommon implements Validator {
	...
	public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
		...
		if (!Validators.checkAnyCharacterNoWhiteSpace((String) value)) {
