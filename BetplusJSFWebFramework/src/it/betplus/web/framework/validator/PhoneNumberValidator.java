...
//@FacesValidator("it.betplus.moneyphone.validators.PhoneNumberValidator")

public class PhoneNumberValidator extends ValidatorCommon implements Validator {
	...
	public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
		...
		if (!Validators.checkCellularNumber((String) value)) {
