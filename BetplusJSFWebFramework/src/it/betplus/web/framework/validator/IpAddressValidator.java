...
//@FacesValidator("it.betplus.moneyphone.validators.IpAddressValidator")

public class IpAddressValidator extends ValidatorCommon implements Validator {
	...
	public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
		...
		if (!Validators.checkIpAddress((String) value)) {
			currentContext.execute("validationResult('" + component.getClientId() + "', '" + false + "', '" + getFromBundleMsgs("invalid_ip_address_format")+ "');");
			throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, "Fail", getFromBundleMsgs("invalid_ip_address_format")));
		}
	}
